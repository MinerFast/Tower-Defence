...
public class GlobalValue : MonoBehaviour {
    ...
    {
        get { return PlayerPrefs.GetInt("ItemPoison", 0); }
        set { PlayerPrefs.SetInt("ItemPoison", value); }
    }

    public static int ItemFreeze
    {
        get { return PlayerPrefs.GetInt("ItemFreeze", 0); }
        set { PlayerPrefs.SetInt("ItemFreeze", value); }
    }

    public static int UpgradeLongShoot
    {
        get { return PlayerPrefs.GetInt("UpgradeLongShoot", 0); }
    ...
    {
        get { return PlayerPrefs.GetInt("UpgradeArcher", 0); }
        set { PlayerPrefs.SetInt("UpgradeArcher", value); }
    }
